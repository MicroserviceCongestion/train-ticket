...
public class AssuranceServiceImplTest {
    ...
    public void testFindAssuranceById2() {
        ...
        Response result = assuranceServiceImpl.findAssuranceById(id, headers);
        Assertions.assertEquals(new Response<>(1, "Find Assurance Success", java.util.Optional.of(assurance)), result);
    }
    ...
    public void testFindAssuranceByOrderId1() {
        ...
        Assertions.assertEquals(new Response<>(0, "No Content by this orderId", null), result);
    }
    ...
    public void testFindAssuranceByOrderId2() {
        ...
        Response result = assuranceServiceImpl.findAssuranceByOrderId(orderId, headers);
        Assertions.assertEquals(new Response<>(1, "Find Assurance Success", assurance), result);
    }
    ...
    public void testCreate1() {
        ...
        Assertions.assertEquals(new Response<>(0, "Fail.Assurance already exists", null), result);
    }
    ...
    public void tesCreate2() {
        ...
        Mockito.when(assuranceRepository.findByOrderId(orderId.toString())).thenReturn(null);
        Response result = assuranceServiceImpl.create(0, orderId.toString(), headers);
        Assertions.assertEquals(new Response<>(0, "Fail.Assurance type doesn't exist", null), result);
    }
    ...
    public void testDeleteById1() {
        ...
        Assertions.assertEquals(new Response<>(1, "Delete Success with Assurance id", null), result);
    }
    ...
    public void testDeleteById2() {
        ...
        Response result = assuranceServiceImpl.deleteById(assuranceId, headers);
        Assertions.assertEquals(new Response<>(0, "Fail.Assurance not clear", assuranceId), result);
    }
    ...
    public void testDeleteByOrderId1() {
        ...
        Assertions.assertEquals(new Response<>(1, "Delete Success with Order Id", null), result);
    }
    ...
    public void testDeleteByOrderId2() {
        ...
        Mockito.when(assuranceRepository.findByOrderId(orderId.toString())).thenReturn(assurance);
        Response result = assuranceServiceImpl.deleteByOrderId(orderId, headers);
        Assertions.assertEquals(new Response<>(0, "Fail.Assurance not clear", orderId), result);
    }
    ...
    public void testModify2() {
        ...
        Assertions.assertEquals(new Response<>(1, "Modify Success", new Assurance(null, null, AssuranceType.TRAFFIC_ACCIDENT)), result);
    }
    ...
    public void testModify3() {
        ...
        Assertions.assertEquals(new Response<>(0, "Assurance Type not exist", null), result);
    }
    ...
    public void testGetAllAssurances1() {
        ...
        Assertions.assertEquals(new Response<>(1, "Success", plainAssuranceList), result);
    }
    ...
    public void testGetAllAssurances2() {
        ...
        Response result = assuranceServiceImpl.getAllAssurances(headers);
        Assertions.assertEquals(new Response<>(0, "No Content, Assurance is empty", null), result);
    }
    ...
    public void testGetAllAssuranceTypes() {
        ...
        Assertions.assertEquals(new Response<>(1, "Find All Assurance", assuranceTypeBeanList), result);
    }
